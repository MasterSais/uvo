import { V_EQ as VALIDATOR_NAME, V_CMP } from '@lib/base-api/names';
...
describe(`validator › ${VALIDATOR_NAME}`, () => {
  ...
  describe('with meta › compile', () =>
    compileWithErrorCases(compile('@compare(=$0)!0 ~e ~m')([right[0][1]], [errorMetaCase([], ['=', right[0][1]], V_CMP)]), [right[0][1], wrong[0][1]])
  );
  ...
  describe('with meta › compile › not', () =>
    compileWithErrorCases(compile('@compare(!=$0)!0 ~e ~m')([right[0][1]], [errorMetaCase([], ['!=', right[0][1]], V_CMP)]), [wrong[0][1], right[0][1]])
  );
});