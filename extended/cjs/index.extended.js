...
const setMetaPath = (meta, path) => (meta && Object.assign(Object.assign({}, meta), { path: meta.path.concat(path) }));
...
exports.V_MAIL = 'email';
exports.V_URL = 'url';
const emailRegEx = new RegExp(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/);
exports.email = ((error) => isFactory(exports.V_MAIL)((value) => emailRegEx.test(value), error));
const fastEmailRegEx = new RegExp(/^\S+@\S+\.\S+$/);
exports.fastEmail = ((error) => isFactory(exports.V_MAIL)((value) => fastEmailRegEx.test(value), error));
const urlRegEx = new RegExp(/^https?:\/\/[^\s$.?#].[^\s]*$/i);
exports.url = ((error) => isFactory(exports.V_URL)((value) => urlRegEx.test(value), error));
